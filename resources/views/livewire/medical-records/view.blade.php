<div class="p-6">
    ...
    <div class="mb-6 pb-4 border-b border-gray-200">
        <div class="flex items-start justify-between">
            ...
            <div class="flex gap-2">
                {{-- Botón Descargar PDF --}}
                <a href="{{ route('medical-records.prescription.download', $record) }}" 
                   target="_blank"
                ...
                <a href="{{ route('medical-records.prescription.stream', $record) }}" 
                   target="_blank"
    ...
    <div class="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
        <p class="text-sm text-green-800 flex items-start gap-2">
            ...
            <span>
                <strong>Seguridad:</strong> Todos los datos clínicos mostrados están encriptados en la base de datos usando AES-256-CBC. 
