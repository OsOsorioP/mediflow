                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <div class="border-l-4 border-{{ $appointment->status->color() }}-500 pl-3 flex-1">
                                        ...
                                        {{-- Estado --}}
                                        <div class="mt-2">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-{{ $appointment->status->color() }}-100 text-{{ $appointment->status->color() }}-800">
                            ...
                            <div class="flex gap-2 ml-4">
                                ...
                                @can('update', $appointment)
                                    @if($appointment->canBeModified())
                                        <button 
                                            wire:click="$dispatch('openModal', { component: 'appointments.edit', arguments: { appointmentId: {{ $appointment->id }} } })"
                                            class="px-3 py-1 text-sm bg-gray-100 text-gray-700 rounded hover:bg-gray-200">
                                            Editar
                                        </button>
                                    @endif
